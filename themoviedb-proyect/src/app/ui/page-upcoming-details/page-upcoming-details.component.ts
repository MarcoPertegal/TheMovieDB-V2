...
@Component({
  selector: 'app-page-upcoming-details',
  templateUrl: './page-upcoming-details.component.html',
  styleUrls: ['./page-upcoming-details.component.css']
})
export class PageUpcomingDetailsComponent implements OnInit {
  castList: Cast[] = [];
  id!: number;
